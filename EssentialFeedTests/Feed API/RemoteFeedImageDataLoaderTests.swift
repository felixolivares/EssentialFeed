...
final class RemoteFeedImageDataLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteFeedDataLoader, toCompleteWith expectedResult: FeedImageDataLoader.Result, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
        let url = URL(string: "https://a-giver-url.com")!
